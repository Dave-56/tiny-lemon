...
export const STYLING_DIRECTION_PRESETS: StylingDirectionPreset[] = [
  {
    ...
    threeQuarterSnippet: 'Body at 45°, left shoulder closer to lens. Weight fully on the right leg; left foot stepped slightly forward and turned slightly outward; left knee softly bent. Right arm falls naturally at side, hand relaxed; left hand rests lightly at waist. Shoulders level; chin slightly down. Face turned back toward lens; direct gaze into camera (or within 0–5° of lens), neck relaxed, no strain. Neutral closed-mouth expression; still and composed. Do not copy the front pose; rotate torso and shoulders 45°.',
    threeQuarterSnippetMale: 'Body at 45°, left shoulder closer to lens. Weight slightly on the right leg; left foot stepped slightly forward; knees soft but straight. Arms relaxed at sides, hands loose and natural. Shoulders level; chin slightly down. Face turned back toward lens; direct gaze into camera (or within 0–5° of lens), neck relaxed, no strain. Neutral closed-mouth expression; composed and still. Do not copy the front pose; rotate torso and shoulders 45°.',
  ...
  },
  {
    ...
    threeQuarterSnippet: 'Body at 45°, left shoulder closer to lens. Weight on the right leg; left foot stepped forward; left knee softly bent; hips naturally shifted. Right arm relaxed at side; left hand loosely at hip, fingers open. Shoulders relaxed, chest open. Direct gaze into camera with a genuine soft smile; warm and approachable. Do not copy the front pose; maintain the 45° body rotation.',
    threeQuarterSnippetMale: 'Body at 45°, left shoulder closer to lens. Weight slightly on the right leg; left foot stepped forward; knees soft. Right arm relaxed at side; left hand loosely at hip. Shoulders relaxed. Direct gaze into camera with a genuine soft smile; approachable and friendly. Do not copy the front pose; maintain the 45° body rotation.',
  ...
  },
  {
    ...
    threeQuarterSnippet: 'Body at 45°, left shoulder visibly closer to lens than right — diagonal shoulder line clearly established. Pronounced weight on the right leg; left foot angled outward; left knee softly bent. Torso rotated away from camera. Both arms hanging at sides: right arm loose, right hand resting flat against outer right thigh, fingers together; left arm hanging fully relaxed, hand loose. Do not place hands in pockets or at waist. Face turned back toward lens; gaze directed 15–20° to the left of camera; chin level or slightly elevated. Neutral-to-serious expression; effortlessly cool. Do not look directly at the camera. Do not face the camera straight on.',
    threeQuarterSnippetMale: 'Body at 45°, left shoulder visibly closer to lens than right — diagonal shoulder line clearly established. Pronounced weight on the right leg; left foot angled outward; left knee softly bent. Torso rotated away from camera. Both arms hanging at sides: right arm loose, right hand flat against outer right thigh; left arm hanging fully relaxed, hand loose. Do not place hands in pockets for this view. Face turned back toward lens; gaze directed 15–20° to the left of camera; chin level or slightly elevated. Neutral-to-serious expression; effortless cool. Do not look directly at the camera. Do not face the camera straight on.',
  ...
  },
  {
    ...
    threeQuarterSnippet: 'Body at 45°, left shoulder visibly closer to lens — diagonal shoulder line clearly established. Upright, elongated stance; weight on the right leg; left foot slightly forward; knees softly straight. Both arms dropped fully at sides: right arm hanging straight, fingers deliberately extended and separated; left arm hanging straight, hand relaxed. Visible natural gap between each arm and the body. No hand at hip; no hand at waist. Shoulders level; chin level. Gaze 12–18° to the left of lens; neutral closed-mouth expression; quiet confidence and stillness. Do not look directly at the camera. Do not face the camera straight on.',
    threeQuarterSnippetMale: 'Body at 45°, left shoulder visibly closer to lens — diagonal shoulder line clearly established. Upright, elongated stance; weight on the right leg; feet comfortably set; knees soft. Both arms hanging straight at sides — arms uncrossed, do not cross arms at chest, do not place hands in pockets. Visible natural gap between each arm and the body. Shoulders level; chin level or slightly elevated. Gaze 12–18° to the left of lens; neutral closed-mouth expression; poised and assured. Do not look directly at the camera. Do not face the camera straight on.',
  ...
  },
  {
    ...
    energyCue: 'Same strong weight shift to right hip, right hand at outer thigh, gaze 20–25 degrees left.',
    ...
    threeQuarterSnippet: 'Body at 45°, left shoulder closer to lens. Relaxed asymmetric stance, strong weight shift to the right hip; left foot stepped forward; knees easy. Shoulders slightly dropped; posture unstudied and loose. Right hand lightly at outer thigh, thumb slightly hooked; left arm relaxed at side, elbow softly bent. Gaze directed 20–25° to the left of camera; chin level. Deadpan cool — not smiling, not serious, just present. Do not look directly at the camera.',
    threeQuarterSnippetMale: 'Body at 45°, left shoulder closer to lens. Strong weight shift to the right hip; left foot stepped forward; knees easy. Shoulders slightly dropped. Both hands deep in trouser pockets, thumbs hooked at edge. Gaze directed 20–25° to the left of camera; chin level. Deadpan cool — not smiling, not serious, just present. Do not look directly at the camera.',
  ...
  },
  {
    ...
    threeQuarterSnippet: 'Body at 45°, left shoulder closer to lens. Feet hip-width, slight bend at knees, weight evenly distributed with a subtle forward lean; core visibly engaged. Left arm slightly forward as if mid-stride; right arm slightly back; hands relaxed. Shoulders align with the body\'s angle; chin up. Forward-focused gaze slightly above horizon; determined neutral expression. Do not look directly at the camera.',
    threeQuarterSnippetMale: 'Body at 45°, left shoulder closer to lens. Feet hip-width, slight bend at knees, even weight with a small forward lean; core engaged. Left arm slightly forward in a natural stride position; right arm slightly back; hands relaxed. Shoulders steady; chin up. Forward-focused gaze slightly above horizon; determined neutral expression. Do not look directly at the camera.',
