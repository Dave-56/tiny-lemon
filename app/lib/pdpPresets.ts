...
export const STYLING_DIRECTION_PRESETS: StylingDirectionPreset[] = [
  ...
  },
  {
    ...
    threeQuarterSnippet: 'Body at 45°, left shoulder closer to lens. Pronounced weight on the right leg; left foot angled outward; left knee softly bent. Torso rotated slightly away from camera. Right hand resting lightly at outer thigh, fingers softly curled inward; left arm hanging fully relaxed at side, hand loose. Face turned back toward lens; gaze directed 15–20° to the left of camera; chin level or slightly elevated. Neutral-to-serious expression; effortlessly cool. Do not look directly at the camera.',
    threeQuarterSnippetMale: 'Body at 45°, left shoulder closer to lens. Pronounced weight on the right leg; left foot angled outward; left knee softly bent. Torso rotated slightly away from camera. Right hand deep in trouser pocket with thumb hooked at edge; left arm hanging relaxed at side, hand loose. Face turned back toward lens; gaze 15–20° to the left of camera; chin level or slightly elevated. Neutral-to-serious expression; effortless cool. Do not look directly at the camera.',
  ...
  },
  {
    ...
    threeQuarterSnippet: 'Body at 45°, left shoulder closer to lens. Upright, elongated stance; weight on the right leg; left foot slightly forward; knees softly straight. Right arm dropped fully at side, fingers deliberately relaxed; left hand loosely at hip. Shoulders level; chin level. Gaze 10–15° to the left of lens; neutral closed-mouth expression; quiet confidence and stillness. Do not look directly at the camera.',
    threeQuarterSnippetMale: 'Body at 45°, left shoulder closer to lens. Upright, elongated stance; weight on the right leg; feet comfortably set; knees soft. Arms crossed loosely at chest (right forearm over left), hands relaxed — not gripping. Shoulders level; chin level or slightly elevated. Gaze 10–15° to the left of lens; neutral closed-mouth expression; poised and assured. Do not look directly at the camera.',
